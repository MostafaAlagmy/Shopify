...
function ProductDetailsDialog({ open, setOpen, productDetails, handleAddtoCart }) {
  ...
  return (
    ...
    <DialogContent className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-[100vw] max-w-[100vw] sm:max-w-[80vw] lg:max-w-[70vw] bg-gray-50 shadow-lg rounded-lg overflow-auto h-[100vh] lg:h-auto lg:max-h-[90vh]  lg:custom-scrollbar  border border-gray-200">
      {/* قسم الصور */}
